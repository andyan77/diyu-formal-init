...
- 当前边界：不依赖真实资料的连续系列、明确平台载体、真实商品最小事实入口和自然用户
  界面薄连接已经完成，并通过本地完整工程门与最终同 SHA CI
  `30169197514`；生产已经部署同 SHA，schema `20260728_22`，镜像摘要
...
- 唯一下一动作：由笛语服饰有权主体在生产租户管理页一次完成总部控制组织/画像、真实门店
  人物账号/画像、本轮商品事实、真实观察种子、制作条件和必要平台载体；完成后执行端立即
  继续两个哨兵篇。不得启动 M7-3。
