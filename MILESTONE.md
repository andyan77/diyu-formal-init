...
- Git 基线：启动时本地与 `origin/main` 均为
  ...
  `52a70348255f64cce6efbe5c082542ecadd2180e`，本地与生产部署仓库干净。
...
- 当前边界：不依赖真实资料的连续系列、明确平台载体、真实商品最小事实入口和自然用户
  ...
  本轮补口本地门为后端 `143 passed`，前端内容/管理端交互均通过；上一生产候选的最终同 SHA CI
  为 `30169197514`，生产已部署该 SHA，schema `20260728_22`，镜像摘要
  `sha256:6e215b58ff04f635dc3f0ec3866be2be956ca0b3a8a676db7d56e518eb81534d`，
  新鲜备份 `20260725T181554Z-predeploy` 可读，本机/公网 readiness 正常。现在进入唯一一次
  合并真实资料动作。六篇源成品和
...
- 唯一下一动作：先把本轮渐进预填补口推送、通过唯一 CI 并部署同 SHA；随后笛语服饰有权主体
  只在生产租户管理页纠正并确认已预填的总部控制组织/画像、1—3 件商品和必要内部平台载体，
  真实门店人物本人另行完成身份、一次激活、画像和一句真实种子。完成后执行端立即继续两个
  哨兵篇。不得启动 M7-3。
