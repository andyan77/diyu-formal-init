...
def upgrade() -> None:
    ...
    op.execute("ALTER POLICY display_products_tenant_scope ON brand_products RENAME TO brand_products_tenant_scope")
    op.execute(
    ...
    op.execute("ALTER TABLE content_versions ADD COLUMN product_contract jsonb NOT NULL DEFAULT '{}'::jsonb")
...
def downgrade() -> None:
    ...
    op.execute("ALTER POLICY brand_products_tenant_scope ON brand_products RENAME TO display_products_tenant_scope")
