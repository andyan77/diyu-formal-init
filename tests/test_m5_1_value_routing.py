...
R1_A = "ZX-C218 这件衣服两面口袋都能用，翻过来也挺上镜。我不想把两面都夸一遍。顾客拿着它比了半天，最怕看完内容还是不知道今天到底把哪一面穿在外面；过两天想换个感觉时，也应该知道什么时候反过来。"
R1_B = "ZX-C218 大家总问“这两面到底哪一面更值得选”，也想看翻面。我不想替她们站队，更不想只拍得好看。就用我们现在知道的这些，让人不再把“双面”轻率地理解成“一件顶两件”；能确认什么、当前还不能下什么结论，都说到位。"
R1_C = "ZX-C218 两面口袋都能用，重量差也有记录，评论里还是在问两面怎么选。这次先别回答，也别把资料念给她。还是同一个人、同一组动作；她刷到时，应该直接看见炭灰和深绿细格纹会把整个人的重音换到不同地方。"
